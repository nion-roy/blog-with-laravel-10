...
<div class="block-header" style="display: flex; align-items: center; justify-content: space-between">
	<a href="{{ route('post.index') }}" class="btn btn-danger waves-effect">
		<i class="material-icons">arrow_back</i>
		<span>BACK</span>
	</a>

	@if ($post->is_approved == 'true')
	<button disabled class="btn btn-success waves-effect"> <i class="material-icons">check</i> <span>Approved</span></button>
	@else
	<button disabled class="btn btn-warning waves-effect"> <i class="material-icons">check</i> <span>Pendding..</span></button>
	@endif
