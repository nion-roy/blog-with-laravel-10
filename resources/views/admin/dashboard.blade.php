			...
			<div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
				<div class="info-box bg-blue-grey hover-zoom-effect">
					...
					<div class="content">
						...
						<div class="number count-to" data-from="0" data-to="{{ $sliders->count() }}" data-speed="1000"
							data-fresh-interval="20">
						</div>
					</div>
				</div>
			...
			<div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
				<div class="info-box bg-black hover-zoom-effect">
					...
					<div class="content">
						...
						<div class="number count-to" data-from="0" data-to="{{ $subscribers->count() }}" data-speed="1000"
							data-fresh-interval="20">
						</div>
					</div>
				</div>
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			<div class="header">
				<div class="row clearfix">
					<div class="col-xs-12 col-sm-6">
						<h2 class="text-uppercase">TOP 10 ACTIVE AUTHORS</h2>
					</div>
				</div>
			</div>
			<div class="body">
